...
import com.heima.pojo.ShopRelated;
...
public class zConsumerController {
    ...
    @GetMapping("/selectAddByShopID/{ShopID}1")
    ...
    @GetMapping("/selectAllAdminMadeOrderByID1")
